...
npm install  @types/node dotenv concurrently --save-dev
npm install eslint eslint-config-prettier eslint-plugin-prettier npm-run-all --save-dev
npm install prettier ts-node --save-dev
npm install
npm dedupe  # Bağımlılıkların tekrarlanan kopyalarını temizler.
npm list  
